 ...
 * state, and never runs inference, learning jobs or permission decisions. Raw
 * evidence and keys stay on the server side; this entry shows a status line and
 * nothing else in Phase 0.
 */
